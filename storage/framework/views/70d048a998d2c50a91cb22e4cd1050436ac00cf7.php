...
<html>
    <head>
        <meta charset="utf-8">
        <title><?php echo e($title); ?>－管理者與網站名稱管理</title>
        ...
        <div class="container">
                ...
                <div class="col-md-8">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <td><button type="button" onclick="model_setting_password(<?php echo e($row->id); ?>);" class="btn btn-default">更改密碼</button></td>
                            <td><button type="button" onclick="model_update(<?php echo e($row->id); ?>);" class="btn btn-default">修改</button></td>
                            <td>
                            <?php if($row->id != 1): ?>
                              <button type="button" onclick="model_delete(<?php echo e($row->id); ?>);" class="btn btn-default">刪除</button><?php endif; ?></td>
                        </tr>
            ...
            <script type="text/javascript">
                ...
                function ajax_update(){
                  ...
                  $.ajax({
                    type: 'post',
                    url: '<?php echo e(url('users')); ?>/'+data_id,
                ...
                function ajax_setting_password(){
                  ...
                  $.ajax({
                    type: 'post',
                    url: '<?php echo e(url('users/password')); ?>/'+data_id,
